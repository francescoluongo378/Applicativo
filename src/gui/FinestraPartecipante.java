...
public class FinestraPartecipante extends JFrame {
    ...
    public FinestraPartecipante(Controller controller, Utente partecipante, JFrame finestraLogin) {
        ...
        JButton b3 = new JButton("Aggiorna Progresso Team");
        ...
        b3.addActionListener(_ -> {
            String valoreStr = JOptionPane.showInputDialog(this, "Incremento Progresso (%) del tuo team:");
            try {
                int incremento = Integer.parseInt(valoreStr);
                boolean ok = controller.aggiornaProgressoTeam(partecipante.getId(), incremento);
                JOptionPane.showMessageDialog(this, ok ? "Progresso aggiornato." : "Errore.");
            } catch (Exception ex) {
